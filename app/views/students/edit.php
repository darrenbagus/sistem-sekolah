...
<body class="min-h-screen flex flex-col bg-gray-100">
    ...
    <header class="bg-blue-800 text-white">
        <div class="flex items-center justify-between container mx-auto p-4">
            ...
            <a href="/students/create" class="bg-white text-blue-500 px-4 py-2 rounded-lg">+ Edit Siswa</a>
        </div>
    </header>
    <!-- Header end -->
    ...
    <!-- card Body start -->
            ...
            <div class="space-y-2">
                ...
                <input class="w-full px-4 py-2 border rounded-lg " type="text" id="telepon" placeholder="Masukkan nomor telepon" name="telepon">
            </div>
